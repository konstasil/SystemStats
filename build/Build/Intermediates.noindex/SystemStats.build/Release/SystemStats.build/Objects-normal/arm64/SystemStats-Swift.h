...
#ifndef SYSTEMSTATS_SWIFT_H
#define SYSTEMSTATS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SystemStats",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11SystemStats11AppDelegate")
...
SWIFT_CLASS("_TtC11SystemStats19StatusBarController")
...
@class NSCoder;
SWIFT_CLASS("_TtC11SystemStats14StatusItemView")
